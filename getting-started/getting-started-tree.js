            ...
            switch(d.data.name) {
                ...
                case 'History':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/history-of-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Why Rockhound?':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/why-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                ...
                case 'Rock Picks & Hammers':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-rock-picks-for-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Chisels':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-chisels-for-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                    case 'Gloves':
                        contentHtml = `<h3>${d.data.name}</h3>
                    ...
                    case 'Use our maps':
                        ...
                        case 'Local Groups':
                            contentHtml = `<h3>${d.data.name}</h3>
                                           ...
                                           <a href="https://www.rockhounding.org/getting-started/local-rockhounding-clubs.html" class="learn-more-button">Learn More</a>`;
                            break;
                        case 'Leave No Trace':
                            contentHtml = `<h3>${d.data.name}</h3>
                        ...
                        case 'When to Look in Streams':
                            contentHtml = `<h3>${d.data.name}</h3>
                                           ...
                                           <a href="https://www.rockhounding.org/getting-started/rockhounding-in-streams.html" class="learn-more-button">Learn More</a>`;
                            break;
                        case 'Checking Banks, Gullies, and Hills':
                            contentHtml = `<h3>${d.data.name}</h3>
                                           ...
                                           <a href="https://www.rockhounding.org/getting-started/rockhounding-tips-banks-gullies-road-cuts-hills.html" class="learn-more-button">Learn More</a>`;
                            break;
                        case 'For Beginners':
                            contentHtml = `<h3>${d.data.name}</h3>
                                           ...
                                           <a href="https://www.rockhounding.org/getting-started/lapidary-for-beginners.html" class="learn-more-button">Learn More</a>`;
                            break;
                        case 'Cutting':
                            contentHtml = `<h3>${d.data.name}</h3>
                                           ...
                                           <a href="https://www.rockhounding.org/getting-started/cutting-in-lapidary.html" class="learn-more-button">Learn More</a>`;
                            break;
                        case 'Shaping':
                            contentHtml = `<h3>${d.data.name}</h3>
