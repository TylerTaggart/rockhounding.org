            ...
            switch(d.data.name) {
                case 'Introduction':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/prospecting-getting-started.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'History':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/history-of-gold.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Why Prospect?':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/why-gold-prospecting.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'What about Gold?':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/prospecting-main.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Gold Pans':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-gold-pan.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Sluice Boxes':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-gold-sluice-box.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Metal Detectors':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-metal-detector.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Dredges':
                    contentHtml = `<h3>${d.data.name}</h3>
                ...
                case 'Gloves':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-gloves.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Safety Glasses':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-safety-glasses.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Bags and Backpacks':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-backpacks-for-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                ...
                case 'First Aid Kit':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/products/best-first-aid-kits.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Use our maps':
                    contentHtml = `<h3>${d.data.name}</h3>
                ...
                case 'Local Groups':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/local-gold-prospecting-clubs.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Leave No Trace Prospecting':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/leave-no-trace-while-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Ethical Collecting while Prospecting':
                    contentHtml = `<h3>${d.data.name}</h3>
                ...
                case 'Gold prospecting on private property':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/private-property-for-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Knowing What to Look For':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/tips-for-rockhounding.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Spraying Rocks to See Them Wet':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/getting-started/spraying-rocks-to-see-them-wet.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'When to Look in Streams':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/gold-prospecting-in-streams.html" class="learn-more-button">Learn More</a>`;
                    break;
                case 'Checking Banks, Gullies, and Hills':
                    contentHtml = `<h3>${d.data.name}</h3>
                                   ...
                                   <a href="https://www.rockhounding.org/gold-prospecting/gold-prospecting-tips-banks-gullies-hills.html" class="learn-more-button">Learn More</a>`;
                    break;
                default:
